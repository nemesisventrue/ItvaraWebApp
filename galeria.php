			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h1><a class="navbar-brand" href="index.php">Acreage</a></h1>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--francisco">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item menu__item--current"><a href="galeria.php" class="menu__link"><span class="menu__helper">Gallery</span></a></li>
							<li class="menu__item"><a href="contacto.php" class="menu__link"><span class="menu__helper">Mail Us</span></a></li>
						</ul>
					</nav>
					<div class="phone">
...
<!-- banner -->
	<div class="banner1">
		<div class="container">
			<h2 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="index.php">Home</a> / <span>Gallery</span></h2>
		</div>
	</div>
<!-- //banner -->
<!-- gallery -->
			...
			<div class="footer-grids1">
				<div class="footer-grids1-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						...
						<li class="active"><a href="galeria.php">Gallery</a></li>
